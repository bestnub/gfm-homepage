    ...
    <card class="flex flex-column" style="width: 100%; height: 100%">
      <template #header>
        <div class="flex justify-content-center">
          <img v-if="imgName || imgUrl" class="gameImg" :src="
      ...
      <template #subtitle>
        <i v-if="uptime.friendlyName == ''" class="pi pi-spin pi-spinner" style="font-size: 1rem"></i>
        <span v-else :class="uptime.online ? 'online' : 'offline'">
      ...
      <template #footer>
        <Button v-if="ip" icon="pi pi-copy" :label="'IP: ' + ip" class="p-button bottom-0" @click.prevent="doCopy" />
        <Button v-if="joinUrl" icon="pi pi-server" :label="'Join now'" class="p-button bottom-0"
